"""
    ...
    The price of a European Put options using the Black-Scholes model.
...
class EuropeanPut:
    def d1(self, asset_price, strike_price, risk_free_rate, volatility, dt):
        ...
        term2 = (risk_free_rate + (0.5 * (volatility**2))) * dt
        numerator = term1 + term2
        denominator = volatility * (dt**.5)
        return numerator/denominator

    def d2(self, d1, volatility, dt):
        return d1 - (volatility * (dt**.5))
    ...
    def price(self, asset_price, d1, strike_price, d2, risk_free_rate, dt):
        ...
        return (strike_price * discount * n2) - (asset_price * n1)
